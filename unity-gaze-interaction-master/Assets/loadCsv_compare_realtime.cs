...
public class loadCsv_compare_realtime : MonoBehaviour
{
    ...
    {
        //CSVname = "./WISS/lrf/3";
        csvDatas = sendPoints.strArr;
        print("user"+sendPoints.strArr.Count);
        //Start();
    }
    ...
    public void UpdateHands(float rate)
    {
        ...
        //print("csvData.count" + csvDatas.Count);
        //print("frame" + frame);
